...
int main(void) {
    ...
    double *grammage = malloc(record_size * sizeof(double));
    ...
    double *gram_temp = malloc(n_particles * sizeof(double));
    ...
    initialize_to_0(gram_temp, n_particles);
    initialize_to_0(grammage, record_size);
    ...
    snprintf(filename1, sizeof(filename1), "MC_gram_record_t1e10_disk10kpc_mfp100pc_v5.bin");
    snprintf(filename2, sizeof(filename2), "MC_time_record_t1e10_disk10kpc_mfp100pc_v5.bin");

    FILE *file1 = fopen(filename1, "wb");
    fwrite(grammage, sizeof(double), ind2, file1);
    fclose(file1);

    FILE *file2 = fopen(filename2, "wb");
    fwrite(time_record, sizeof(double), ind2, file2);
    fclose(file2);
